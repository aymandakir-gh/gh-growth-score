    ...
    <div className="rounded-2xl border border-brand-500/30 bg-gradient-to-br from-brand-950/80 to-slate-900 p-6 sm:p-8">
      ...
      <div className="text-center mb-6">
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap">
          ...
          <span
            className={`text-sm font-medium px-2.5 py-1 rounded-full bg-slate-800 border border-slate-700 ${scoreColor(overallScore)}`}
          >
      ...
      >
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-2.5 rounded-lg bg-slate-800 border text-white placeholder-slate-500 text-sm focus:outline-none focus:ring-1 transition-colors ${
              hasError
                ? "border-red-500 focus:border-red-500 focus:ring-red-500/50"
                : "border-slate-700 focus:border-brand-500 focus:ring-brand-500/50"
            }`}
          />
        </div>
