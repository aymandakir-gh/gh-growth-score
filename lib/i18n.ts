...
const en: TranslationDict = {
  ...
  "results.legend.critical": "Critical (<30)",
  "results.legend.needsWork": "Needs work (30-54)",
  "results.legend.good": "Good (55-74)",
  "results.legend.excellent": "Excellent (75+)",
...
const ar: TranslationDict = {
  ...
  "results.legend.critical": "حرج (<30)",
  "results.legend.needsWork": "يحتاج تحسين (30-54)",
  "results.legend.good": "جيد (55-74)",
  "results.legend.excellent": "ممتاز (75+)",
...
const it: TranslationDict = {
  ...
  "results.legend.critical": "Critico (<30)",
  "results.legend.needsWork": "Da migliorare (30-54)",
  "results.legend.good": "Buono (55-74)",
  "results.legend.excellent": "Eccellente (75+)",
...
const nl: TranslationDict = {
  ...
  "results.legend.critical": "Kritiek (<30)",
  "results.legend.needsWork": "Verbetering nodig (30-54)",
  "results.legend.good": "Goed (55-74)",
  "results.legend.excellent": "Uitstekend (75+)",
...
const zh: TranslationDict = {
  ...
  "results.legend.critical": "严重 (<30)",
  "results.legend.needsWork": "需改进 (30-54)",
  "results.legend.good": "良好 (55-74)",
  "results.legend.excellent": "优秀 (75+)",
...
const es: TranslationDict = {
  ...
  "results.legend.critical": "Crítico (<30)",
  "results.legend.needsWork": "Necesita mejora (30-54)",
  "results.legend.good": "Bueno (55-74)",
  "results.legend.excellent": "Excelente (75+)",
...
const fr: TranslationDict = {
  ...
  "results.legend.critical": "Critique (<30)",
  "results.legend.needsWork": "À améliorer (30-54)",
  "results.legend.good": "Bon (55-74)",
  "results.legend.excellent": "Excellent (75+)",
...
const de: TranslationDict = {
  ...
  "results.legend.critical": "Kritisch (<30)",
  "results.legend.needsWork": "Verbesserungsbedarf (30-54)",
  "results.legend.good": "Gut (55-74)",
  "results.legend.excellent": "Ausgezeichnet (75+)",
...
const ptBr: TranslationDict = {
  ...
  "results.legend.critical": "Crítico (<30)",
  "results.legend.needsWork": "Precisa melhorar (30-54)",
  "results.legend.good": "Bom (55-74)",
  "results.legend.excellent": "Excelente (75+)",
